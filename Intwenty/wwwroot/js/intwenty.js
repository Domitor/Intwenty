...
function getVueCreateUpdate(vueelement, applicationid, apptablename, baseurl) {
    ...
    var app = new Vue({
        ...
        data: {
            ...
            model: { [apptablename]: {} },
            validation: {},
            pageInfo: { "applicationId": applicationid, "dataViewMetaCode": "", "maxCount": 0, "pageSize": 8, "pageNumber": 0, "filterValues": [] },
            current_edit_line: {},
            showFilter: false,
            dlgFilterColumnName: "",
            dlgFilterValue: ""
...
function getEditListView(vueelement, applicationid, baseurl, pagesize) {
    ...
    var app = new Vue({
        ...
        data: {
            ...
            , pageInfo: { "applicationId": applicationid, "maxCount": 0, "pageSize": pagesize, "pageNumber": 0, "filterValues": [] }
            , currentSort: ''
            , currentSortDir: 'asc'
            , baseUrl: baseurl
        ...
        methods: {
            ...
            exportToExcel: function () {
                var args = { "applicationId": applicationid, "maxCount": 0, "pageSize": 2000, "pageNumber": 0, "filterValues": [] }
                var context = this;
                var endpointurl = context.baseUrl + "GetEditListData";
...
function getListView(vueelement, applicationid, baseurl, pagesize) {
    ...
    var app = new Vue({
        ...
        data: {
            datalist: []
            , model: {}
            , pageInfo: { "applicationId": applicationid, "maxCount": 0, "dataViewMetaCode": "", "pageSize": pagesize, "pageNumber": 0, "filterValues": [] }
            , currentSort: ''
            , currentSortDir: 'asc'
            , baseUrl: baseurl
