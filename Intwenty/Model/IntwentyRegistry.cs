...
namespace Intwenty.Model
{
    public static class IntwentyRegistry
    {
        ...
        private static List<IntwentyMetaType> GetMetaTypes()
        {
            ...
            _metatypes.Add(new IntwentyMetaType() { Code = UserInterfaceModelItem.MetaTypeListViewColumn, Title = "List View Column" , ModelCode = "UIMODEL" });
            ...
            _metatypes.Add(new IntwentyMetaType() { Code = UserInterfaceModelItem.MetaTypeUpdateView, Title = "Update View" , ModelCode = "UIMODEL" });
